...
ax1.set_yscale('log')
ax1.set_ylim(1.0,7.0e7)
ax1.set_xlim(25.0,150.0)
ax1.set_ylabel('Infectious')
ax1.plot(t, Inf, color='red',label='$\\rho = 0.001$')
ax1.plot(t2, Inf2, color='black',ls='dashed',label='$\\rho = 0.01$')
ax1.plot(t3, Inf3, color='blue', ls='dotted',label='$\\rho = 0.1$')
